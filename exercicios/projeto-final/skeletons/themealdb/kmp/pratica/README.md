# Projeto Final — TheMealDB (receitas) em Kotlin Multiplatform (Compose)
...
> ⚠️ Antes de codar: seu grupo **reservou** a combinação `themealdb + kmp` abrindo issue no
...
cd exercicios/projeto-final/skeletons/themealdb/kmp/pratica
