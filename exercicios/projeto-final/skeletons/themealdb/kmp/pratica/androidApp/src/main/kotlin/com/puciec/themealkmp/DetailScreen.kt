...
import com.puciec.themealkmp.data.MealDetail
...
fun DetailScreen(
    ...
    var detail by remember { mutableStateOf<MealDetail?>(null) }
    var isFavorite by remember { mutableStateOf(favoritesStore.load().contains(mealId)) }
    var error by remember { mutableStateOf<String?>(null) }

    LaunchedEffect(mealId) {
        // TODO 2 (feature 2 — detalhe): chamar api.fetchDetail(mealId) e
                    ...
                    Text(
                        ...
                        modifier = Modifier
                            ...
                            .clickable {
                                ...
                                // favoritesStore.toggle(mealId) e atualizar
                                // `isFavorite` com o resultado.
                            },
                        style = MaterialTheme.typography.headlineMedium,
                    )
                }
                Text("Categoria: ${d.strCategory ?: ""}")
                Text("Área: ${d.strArea ?: ""}")
            }
        }
    }
