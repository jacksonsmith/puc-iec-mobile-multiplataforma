# Projeto Final — TheMealDB (receitas) em Flutter
...
> ⚠️ Antes de codar: seu grupo **reservou** a combinação `themealdb + flutter` abrindo issue no
...
cd exercicios/projeto-final/skeletons/themealdb/flutter/pratica
