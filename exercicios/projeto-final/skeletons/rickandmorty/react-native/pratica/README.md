# Projeto Final — Rick and Morty em React Native (Expo)
...
> ⚠️ Antes de codar: seu grupo **reservou** a combinação `rickandmorty + react-native` abrindo issue no
...
cd exercicios/projeto-final/skeletons/rickandmorty/react-native/pratica
