# Projeto Final — Rick and Morty em Flutter
...
> ⚠️ Antes de codar: seu grupo **reservou** a combinação `rickandmorty + flutter` abrindo issue no
...
cd exercicios/projeto-final/skeletons/rickandmorty/flutter/pratica
