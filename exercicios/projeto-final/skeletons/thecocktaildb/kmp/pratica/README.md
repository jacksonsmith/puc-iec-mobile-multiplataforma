# Projeto Final — TheCocktailDB (drinks) em Kotlin Multiplatform (Compose)
...
> ⚠️ Antes de codar: seu grupo **reservou** a combinação `thecocktaildb + kmp` abrindo issue no
...
cd exercicios/projeto-final/skeletons/thecocktaildb/kmp/pratica
