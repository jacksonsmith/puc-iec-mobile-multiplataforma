# Projeto Final — Pokédex (PokeAPI) em Flutter
...
> ⚠️ Antes de codar: seu grupo **reservou** a combinação `pokeapi + flutter` abrindo issue no
...
cd exercicios/projeto-final/skeletons/pokeapi/flutter/pratica
