# Projeto Final — Pokédex (PokeAPI) em Kotlin Multiplatform (Compose)
...
> ⚠️ Antes de codar: seu grupo **reservou** a combinação `pokeapi + kmp` abrindo issue no
...
cd exercicios/projeto-final/skeletons/pokeapi/kmp/pratica
