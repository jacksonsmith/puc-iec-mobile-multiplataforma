# Projeto Final — Pokédex (PokeAPI) em React Native (Expo)
...
**API deste tema:** PokeAPI — 151 pokémons; filtro por `type`; id `Int`.
Endpoints exatos, fixtures dos testes e gotchas: [`temas/01-pokeapi/README.md`](../../../../temas/01-pokeapi/README.md).
Regras completas e rubrica: [`enunciado.md`](../../../../enunciado.md).

> ⚠️ Antes de codar: seu grupo **reservou** a combinação `pokeapi + react-native` abrindo issue no
...
cd exercicios/projeto-final/skeletons/pokeapi/react-native/pratica
